  ...
  return (
    <div className="App">
      ...
      <div className="code-challenge">
        <div>
          <div className="title">Code Challenge</div>
          <hr color="blue" className="hr" />
          <p className="sub-title">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod</p>
      ...
      <div className="code-challenge-body">
        <div className="element">
          <div className="element-center">
            <img src="/svg/pointer-top.svg" />
          </div>
          <div className="element-title">Fully functional</div>
          <div className="element-center">
            <p className="element-content">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod</p>
          </div>
        </div>
        <div className="element">
          <div className="element-center">
      ...
      <div className="work-faster-wrapper">
        <div className="work-faster">
          <img src="/Images/images/thumb-2 (1).png" />
          <div className="work-faster-content">
            <div className="work-faster-title">Work faster with powerful tools.</div>
            <div className="work-faster-text">
              <p><img src="/svg/arrow-right.svg" />Combined with a handful of model sentence structures looks reasonable</p>
              <p><img src="/svg/arrow-right.svg" />Contrary to popular belief, Lorem lpsum is not simply random text.</p>
              <p><img src="/svg/arrow-right.svg" />Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium.</p>
              <p><img src="/svg/arrow-right.svg" />Natus error sit voluptatem unde amnis iste natus error sit voluptatem accusantium</p>
              <p><img src="/svg/arrow-right.svg" />All the Lorem lpsum generators on the internet tend to repeat necessary.</p>
            </div>
            <div className="icons">
              <img src="/svg/facebook-messenger.svg" />
              <img src="/svg/lifering.svg" />
              <img src="/svg/map-marker.svg" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="challenge-tips">
        <div className="challenge-tips-header">
          ...
          <p className="challenge-tips-sub-title">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore</p>
          <p className="challenge-tips-sub-title">et dolore magna aliqua. Ut enim ad minim veniam</p>
        </div>
        <div className="challenge-tips-body-wrapper">
          <div className="challenge-tips-body">
            <div className="challenge-tips-body-element">
              <div className="flex">
                <div>
                  <img src="/svg/cloud-download.svg" />
                  <p>Install the App</p>
